...
```{r EntireData, echo=FALSE, results='hide'}
...
------------- | -------------
connected_district  | The rows have the names of 50 districts of Bangkok. The colums tell its connecions to other districts.
Cell 3 | Cell 4 
...
```{r fig1,fig.width=4,fig.height=4,echo=FALSE,message=FALSE,include=TRUE,fig.cap="The plot shows that You are fucked up."}
