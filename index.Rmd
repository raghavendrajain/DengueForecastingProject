...
ggplot(totalDHF, aes(x = date_sick_year, y = count )) + geom_bar(stat = "identity")  + ggtitle(" Reported DHF incidents in Bangkok (2008-2015)") + labs(x="Year",y="Yearly Count Data")
