...
DHF_yearly_2008.2015 <- subset(DHF_bangkok_district_level_2008.2015, select = - c(geocode_district, disease_code ))

head(DHF_yearly_2008.2015)

a<-tapply(DHF_yearly_2008.2015$count, DHF_yearly_2008.2015$date_sick_year, FUN=sum)
