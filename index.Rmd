...
bayesianDF.train <- subset(bayesianDF.train, select=c("count", "DTR", "Rainfall", "Month"))


bayesianDF.test <- subset(bayesianDF, date_sick_year== 2015 )
bayesianDF.test <- subset(bayesianDF.test, select=c("count", "DTR", "Rainfall", "Month"))

dag<-model2network("[Month][DTR|Month][Rainfall|Month][count|DTR:Rainfall]")
